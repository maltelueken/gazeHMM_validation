---
title: "Results parameter recovery"
author: "Malte Lüken"
date: "22.05.2020"
output: 
...
```{r load data and prepare functions, include=FALSE}
...
# Root Median Square Proportion Deviation (RMdSPD)
...
```{r plot part 4 4 states}

print(plots.rmsd.234[[3]][[3]])

```

# Linear Regression Between Estimated and True Parameters

```{r calculate linear regressions, include=F}
...
```{r calculate proportion of erroneous models, include=FALSE}
