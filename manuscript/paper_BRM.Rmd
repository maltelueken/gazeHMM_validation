...
print(plots.rmsd.234[[1]][[1]] + coord_flip() + theme(axis.text.x = element_text(size = 10)))
...
print(plots.rmsd.234[[1]][[2]] + coord_flip() + theme(axis.text.x = element_text(size = 8)))
...
print(plots.rmsd.234[[1]][[3]] + coord_flip() + theme(axis.text.x = element_text(size = 9)))
