...
HMMs have another property that has been rarely used in the context of eye movement classification: They can serve as a generative model for gaze data. Only @Mihali2017 used this property by building an explicit generative model for drift and microsaccades.  
...
The algorithm is implemented in R [version: 3.6.3; @RCoreTeam2020] and uses the packages signal [@Ligges2015] to compute velocity and acceleration signals, depmixS4 [@Visser2010] for the HMM, CircStats [@Lund2018] for the von Mises distribution, and BB [@Varadhan2009] for Barzilai-Borwein spectral projected gradient optimization. The algorithm is available on GitHub (www.github.com/maltelueken/gazeHMM).
