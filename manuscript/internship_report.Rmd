...
knitr::include_graphics(here("manuscript/internship_report_files/external-files/hmm-structure.png"), auto_pdf = T, dpi = 400)
...
print(plots.rmsd.234[[2]][[1]] + theme(axis.text = element_text(size = 8)))
...
print(plots.rmsd.234[[2]][[2]] + theme(axis.text = element_text(size = 6)))
...
print(plots.rmsd.234[[2]][[3]] + theme(axis.text = element_text(size = 8)))
...
print(plots.rmsd.234[[3]][[1]] + theme(axis.text = element_text(size = 8)))
...
print(plots.rmsd.234[[3]][[2]] + theme(axis.text = element_text(size = 6)))
...
print(plots.rmsd.234[[3]][[3]] + theme(axis.text = element_text(size = 8)))
